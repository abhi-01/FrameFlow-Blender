...
#             # Filter only "Travel & Places" category
#             for emoji, data in all_emojis.items():
#                 if data.get("category") == "Travel & Places":
...
#     print(f"Loaded {len(emoji_data)} emojis from Travel & Places category")
#     return emoji_data
...
# class TEXT_OT_EMOJI_TRAVEL_AND_PLACES(bpy.types.Operator):
...
#         context.scene.emoji_active_category = 'TRAVEL_AND_PLACES'
#         return {'FINISHED'}


# class TEXT_OT_INSERT_TRAVEL_AND_PLACES(bpy.types.Operator):
...
# class TEXT_PT_EMOJI_TRAVEL_AND_PLACES(bpy.types.Panel):
#     bl_space_type = 'TEXT_EDITOR'
#     bl_region_type = 'UI'
#     bl_category = "Editor Ⓕ"
#     bl_label = "Travel & Places"
...
#         return context.scene.emoji_active_category == 'TRAVEL_AND_PLACES'
