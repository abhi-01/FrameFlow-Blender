...
#             # Filter only "Food & Drink" category
...
#     print(f"Loaded {len(emoji_data)} emojis from Food & Drink category")
#     return emoji_data
...
class TEXT_OT_EMOJI_FOOD_AND_DRINK(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        context.scene.emoji_active_category = 'FOOD_AND_DRINK'
        # context.scene.emoji_active_category = '"Food & Drink"'
        return {'FINISHED'}


class TEXT_OT_INSERT_FOOD_AND_DRINK(bpy.types.Operator):
...
class TEXT_PT_EMOJI_FOOD_AND_DRINK(bpy.types.Panel):
    bl_space_type = 'TEXT_EDITOR'
    bl_region_type = 'UI'
    bl_category = "Editor Ⓕ"
    bl_label = "Food & Drink"
    ...
    def poll(cls, context):
        return context.scene.emoji_active_category == 'FOOD_AND_DRINK'
