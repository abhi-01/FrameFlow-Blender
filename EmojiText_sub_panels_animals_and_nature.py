...
class TEXT_OT_EMOJI_ANIMALS_AND_NATURE(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        context.scene.emoji_active_category = 'ANIMALS_AND_NATURE'
        return {'FINISHED'}


class TEXT_OT_INSERT_ANIMALS_AND_NATURE(bpy.types.Operator):
...
class TEXT_PT_EMOJI_ANIMALS_AND_NATURE(bpy.types.Panel):
    bl_space_type = 'TEXT_EDITOR'
    bl_region_type = 'UI'
    bl_category = "Editor Ⓕ"
    bl_label = "Animals & Nature"
    ...
    def poll(cls, context):
        return context.scene.emoji_active_category == 'ANIMALS_AND_NATURE'
